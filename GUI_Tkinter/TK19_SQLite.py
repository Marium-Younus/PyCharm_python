...
def database():
    ...
    with connection:
        ...
        cursor.execute('CREATE TABLE IF NOT EXISTS STUDENT (First TEXT,Last TEXT,Dob TEXT,Country TEXT,Programming TEXT,Gender TEXT)')
        cursor.execute('INSERT INTO Student(Name,Last,Dob,Country,Programming,Gender) VALUES (?,?,?,?,?,?)',(fname,lname,date,u_country,checkval,gender))
...
img = Button(window, image=login_btn, borderwidth=0,command=database)
